    ...
    pub async fn query(
        ...
        if query_embeddings.is_some() && query_texts.is_some() {
            ...
            query_embeddings = Some(
                embedding_function
                    .unwrap()
                    .embed(query_texts.unwrap()).await?,
            );
        };
...
async fn validate(
    ...
    if embeddings.is_none() && documents.is_some() && embedding_function.is_some() {
        embeddings = Some(
            embedding_function
                .unwrap()
                .embed(documents.clone().unwrap()).await?,
        );
    }
...
mod tests {
    ...
    async fn test_add_to_collection() {
        ...
        let invalid_collection_entries = CollectionEntries {
            ...
            metadatas: None,
            documents: Some(vec![
                "Document content 1".to_string(),
                "Document content 2".to_string(),
            ]),
            embeddings: None,
        };
        let response = collection.add(
        ...
        let valid_collection_entries = CollectionEntries {
            ids: vec!["test1".to_string(), "test2".to_string()],
            metadatas: None,
            documents: Some(vec![
                "Document content 1".to_string(),
                "Document content 2".to_string(),
        ...
        let invalid_collection_entries = CollectionEntries {
            ids: vec!["test1".to_string(), "".to_string()],
            metadatas: None,
            documents: Some(vec![
                "Document content 1".to_string(),
                "Document content 2".to_string(),
        ...
        let invalid_collection_entries = CollectionEntries {
            ids: vec!["test".to_string(), "test".to_string()],
            metadatas: None,
            documents: Some(vec![
                "Document content 1".to_string(),
                "Document content 2".to_string(),
